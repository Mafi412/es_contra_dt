...
# The following methods do not differ between ns and qd, hence we use the original implementations.
from ns.funcs import prepare_iteration, prepare_for_evaluations, finish_evaluations_part_of_iteration, update, evaluate_and_possibly_save, log_iteration_population_data
...
def evaluations(
    ...
    fitness, behavior_characteristic, runtime, sum, sum_of_squares, count = evaluation(test_model, test_environment, max_runtime, update_vbn_stats)
...
def evaluation(
    ...
    return episode_return, behavior_characteristic, episode_length, sum_, sum_of_squares, count
