...
def head_process(
    ...
    ## Novelty reporting arrays (1 for plus noise, 2 for minus noise) and rank_weight array for update.
    ...
    for i in range(len(models)):
        behavior_characteristic, _, _, _, _ = funcs.evaluation(models[i], test_environment, None, False)
    ...
    for iteration in progress_bar:
        ...
        behavior_characteristic, _, _, _, _ = funcs.evaluation(models[current_model_index.value], test_environment, None, False)
