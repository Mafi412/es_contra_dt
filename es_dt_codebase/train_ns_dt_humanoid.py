...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_of_iterations", type=int, default=400, help="Number of iterations the ES will run.")
    ...
    parser.add_argument("--num_of_nearest_neighbors_to_average", type=int, default=3, help="Number of nearest neighbors in archive that will be considered and distance to them averaged when computing the novelty.")
